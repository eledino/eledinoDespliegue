...
.contacto input[type='number'], .contacto textarea{
    ...
    <body>
        ...
        %>
         ...
         <form action="../ServletControladorAbrirEscrutinio"  method="post"> 
        <table width="500px" heigh="300px" class="contacto" align="center">
                    <tr>
                        <td colspan="3" align="center"><h1><strong>Abrir Escrutinio</strong></h1>
                    </tr>
                    <tr>
                        <td align ="center"><h2>¿Desea abrir el escrutinio?</h2> </td>
